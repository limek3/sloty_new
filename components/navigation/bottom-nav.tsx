                  ...
                  <div className="relative flex w-full items-center justify-center">
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute left-1/2 top-1/2 h-11 w-12 -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-primary/20 bg-gradient-to-b from-primary/20 to-primary/8 shadow-[0_6px_16px_rgba(0,0,0,0.12)]"
                        transition={{
                          type: 'spring',
                          stiffness: 420,
                          damping: 32,
