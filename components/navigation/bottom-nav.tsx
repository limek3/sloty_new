  ...
  return (
    <nav className="pointer-events-none fixed inset-x-0 bottom-0 z-50 px-3 pb-4 safe-bottom">
      <div className="mx-auto max-w-md">
        <div className="pointer-events-auto relative overflow-hidden rounded-[24px] border border-border bg-card/95 px-2 py-1.5 shadow-premium backdrop-blur-xl">
          {/* Top gradient line */}
                  ...
                  <div className="relative flex w-full items-center justify-center">
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute left-1/2 top-1/2 h-10 w-12 -translate-x-1/2 -translate-y-1/2 rounded-[14px] border border-primary/15 bg-gradient-to-b from-primary/12 to-primary/6 shadow-[0_6px_16px_rgba(0,0,0,0.06),inset_0_1px_0_rgba(255,255,255,0.8)]"
                        transition={{
                          type: 'spring',
                          stiffness: 420,
                          damping: 32,
