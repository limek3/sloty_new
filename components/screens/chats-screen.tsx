          ...
          <div className="rounded-[22px] border border-border/70 bg-card p-2.5 shadow-[0_8px_28px_rgba(15,23,42,0.05)]">
            ...
            <div className="relative mt-1">
              ...
              <input
                ...
                className="h-9 w-full rounded-[12px] border border-border/70 bg-[#f7f7f5] pl-9 pr-3 ty-body text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-emerald-200 focus:bg-card"
              />
            </div>
          </div>
        </div>
                ...
                >
                  <div className="relative shrink-0">
                    {chat.participantAvatar ? (
                      ...
                      <div className="flex h-10 w-10 items-center justify-center rounded-[12px] bg-emerald-100 ty-body font-bold text-emerald-700">
                    ...
                    {hasUnread && (
                      <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-rose-500 px-0.5 ty-overline font-bold text-white shadow-[0_6px_14px_rgba(244,63,94,0.22)]">
                        {chat.unreadCount}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2.5">
                      <div className="min-w-0">
                        <h3
                          className={`truncate ty-body font-semibold ${
                        ...
                        <div className="mt-0.5 flex items-center gap-0.5 ty-body text-slate-400">
                      ...
                      <div className="shrink-0 text-right">
                        ...
                        {!hasUnread && (
                          <div className="mt-0.5 inline-flex items-center gap-0.5 ty-overline text-slate-400">
                    ...
                    <div className="mt-1 flex items-center gap-1.5">
                      <p
                        className={`min-w-0 flex-1 truncate ty-subtitle ${
                          hasUnread
