            ...
            {displayRequests.map((request) => (
              ...
              >
                ...
                <div className="mt-2 flex flex-wrap items-center gap-1">
                  <span className="rounded-full border border-border/70 bg-[#fafaf8] px-2 py-0.5 text-[13px] font-medium text-slate-700">
                    {request.category}
                  </span>

                  <div className="inline-flex items-center gap-0.5 rounded-full bg-slate-100 px-1.5 py-0.5 text-[13px] text-slate-600">
