          ...
          <div className="rounded-[22px] border border-border/70 bg-card p-2.5 shadow-[0_8px_28px_rgba(15,23,42,0.05)]">
            <div className="flex items-start gap-2.5 px-0.5 pb-1.5 pt-0.5">
              ...
              >
                ...
                <span className="absolute -right-0.5 -top-0.5 flex h-3.5 min-w-3.5 items-center justify-center rounded-full bg-rose-500 px-0.5 ty-overline font-bold text-white">
                  2
                </span>
              </button>
            </div>
            ...
            <div className="mt-1 grid grid-cols-3 gap-2">
              ...
              <div className="rounded-[12px] border border-border/70 bg-[#fafaf8] p-2 text-center">
                <div className="flex items-center justify-center gap-0.5">
                  ...
                  <p className="ty-body font-bold tracking-tight text-slate-900">4.9</p>
                </div>
                <p className="mt-0.5 ty-body text-slate-500">
                  {isRu ? 'Рейтинг' : 'Rating'}
                </p>
      ...
      <main className="mx-auto max-w-2xl space-y-3 px-3 py-3">
        <section className="rounded-[18px] border border-border/70 bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <h2 className="ty-subtitle font-semibold text-slate-900">
              {t('settings')}
            </h2>
          </div>
              ...
              <div className="flex items-center justify-between gap-2.5">
                <div className="flex min-w-0 items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="ty-body font-medium text-slate-900">
                      {t('language')}
                    </p>
                ...
                <div className="flex items-center rounded-[10px] border border-border/70 bg-card p-0.5">
                  <button
                    ...
                    className={`rounded-[8px] px-2 py-1 ty-subtitle font-semibold transition ${
                      language === 'ru'
            ...
            <div className="rounded-[14px] border border-border/70 bg-[#fafaf8] p-2.5">
              <div className="flex items-center justify-between gap-2.5">
                <div className="flex min-w-0 items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="ty-body font-medium text-slate-900">{t('theme')}</p>
                    <p className="ty-body text-slate-500">{theme === 'dark' ? t('darkMode') : t('lightMode')}</p>
                  </div>
                </div>
                <button
                  onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
                  className="rounded-[10px] border border-border/70 bg-card px-3 py-1.5 ty-subtitle font-semibold text-slate-700 transition hover:bg-slate-50"
                >
        ...
        {menuSections.map((section, sectionIndex) => (
          <section key={sectionIndex}>
            <h2 className="mb-2 px-0.5 ty-subtitle font-semibold uppercase tracking-[0.1em] text-slate-400">
              {section.title}
            </h2>
        ...
        <button className="flex w-full items-center justify-center gap-1.5 rounded-[14px] border border-rose-200 bg-rose-50 p-2.5 ty-body font-medium text-rose-600 transition hover:bg-rose-100">
          <LogOut className="h-4 w-4" />
          {isRu ? 'Выйти' : 'Log out'}
        </button>

        <p className="pb-1 text-center ty-body text-slate-400">Sloty v1.0.0</p>
      </main>
