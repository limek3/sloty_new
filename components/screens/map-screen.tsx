  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-background">
      ...
      <div className="absolute inset-x-0 top-0 z-[1000] px-3 pt-3 safe-top">
        <div className="rounded-[18px] border border-border/70 bg-card/95 p-2 shadow-[0_8px_28px_rgba(15,23,42,0.08)] backdrop-blur-xl">
          <div className="relative">
            ...
            <input
              ...
              className="h-10 w-full rounded-[12px] border border-border/70 bg-[#f7f7f5] pl-9 pr-9 ty-body text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-emerald-200 focus:bg-card"
            />
            {searchQuery && (
              <button
            ...
            {filterTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`h-8 shrink-0 rounded-[10px] px-3 ty-subtitle font-medium transition-all ${
                    active
        ...
        <div className="mt-2 inline-flex rounded-full border border-border/70 bg-card/95 px-2.5 py-1 ty-subtitle font-medium text-slate-700 shadow-[0_4px_12px_rgba(15,23,42,0.05)] backdrop-blur-xl">
          {isRu
            ...
            <div className="px-4">
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      <SheetTitle className="truncate ty-body font-bold tracking-tight text-slate-900">
                        {selectedMaster.name}
                      </SheetTitle>
                    ...
                    <p className="truncate ty-subtitle text-slate-500">
                      {selectedMaster.specialization}
                    </p>

                    <div className="mt-1.5 flex flex-wrap items-center gap-2">
                      <div className="flex items-center gap-0.5 ty-subtitle">
                      ...
                      <div className="flex items-center gap-0.5 ty-subtitle text-slate-500">
              ...
              <div className="mb-3 grid grid-cols-2 gap-2">
                <div className="rounded-[14px] border border-border/70 bg-[#fafaf8] p-2.5">
                  <p className="mb-0.5 ty-body text-slate-500">{t('from')}</p>
                  <p className="ty-body font-bold text-emerald-600">
                    {formatPrice(selectedMaster.priceFrom)}
                  </p>
                </div>

                <div className="rounded-[14px] border border-border/70 bg-[#fafaf8] p-2.5">
                  <p className="mb-0.5 ty-body text-slate-500">
                    {isRu ? 'Адрес' : 'Address'}
                  </p>
              ...
              {showRouting && (
                <div className="mb-3 flex items-center gap-2.5 rounded-[14px] border border-emerald-100 bg-emerald-50 p-2.5">
                  ...
                  <div className="flex-1">
                    <p className="ty-body font-semibold text-slate-900">
                  ...
                  <Button
                    ...
                    className="h-8 rounded-[10px] border-border/70 bg-card px-2.5 ty-subtitle"
                  >
              ...
              <div className="mb-3 grid grid-cols-3 gap-2">
                <Button
                  variant="outline"
                  className="h-10 rounded-[12px] border-border/70 bg-card ty-subtitle"
              ...
              <Button
                className="h-11 w-full rounded-[14px] bg-emerald-500 ty-subtitle font-semibold text-white shadow-[0_12px_26px_rgba(16,185,129,0.25)] hover:bg-emerald-600"
