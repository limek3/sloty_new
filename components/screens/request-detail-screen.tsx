      ...
      <div className="min-h-screen bg-[#f6f6f3] px-4 safe-top safe-bottom">
        <div className="flex min-h-screen items-center justify-center">
          <div className="rounded-[16px] border border-border/70 bg-card px-4 py-6 text-center shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
            <p className="text-[12px] text-slate-500">{t('error')}</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="app-shell safe-bottom">
      ...
      <main className="mx-auto max-w-2xl space-y-2.5 px-3 py-3">
        <section className="rounded-[18px] border border-border/70 bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
          <span className="inline-flex rounded-full border border-border/70 bg-[#fafaf8] px-2 py-0.5 text-[13px] font-medium text-slate-700">
            {request.category}
          </span>

          <h2 className="mt-2 text-[13px] font-bold leading-[1.4] tracking-tight text-slate-900">
            {request.title}
          </h2>

          <p className="mt-2 text-[12px] leading-[1.5] text-slate-600">
            {request.description}
          </p>
        </section>
        ...
        <section className="rounded-[18px] border border-border/70 bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[13px] text-slate-500">{request.createdAt}</p>
            </div>
        ...
        <section className="grid grid-cols-2 gap-2">
          <div className="rounded-[14px] border border-border/70 bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
            <p className="text-[13px] text-slate-500">{t('budget')}</p>
          ...
          <div className="rounded-[14px] border border-border/70 bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
            <p className="text-[13px] text-slate-500">{t('responses')}</p>
            <p className="mt-1 text-[12px] font-bold tracking-tight text-slate-900">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2.5 rounded-[12px] bg-[#f7f7f5] px-2.5 py-2">
              ...
              <div>
                ...
                <p className="text-[12px] font-medium text-slate-800">{request.location}</p>
              </div>
            </div>
        ...
        {userRole === 'master' && request.responsesCount > 0 && (
          <section className="rounded-[18px] border border-border/70 bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
            ...
            <p className="mt-1 text-[12px] leading-[1.4] text-slate-500">
              {isRu
