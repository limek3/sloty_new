  ...
  return (
    <div className="app-shell safe-bottom">
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-[22px] border border-border/70 bg-card p-2.5 shadow-[0_8px_28px_rgba(15,23,42,0.05)]">
            <div className="flex items-start gap-2.5 px-0.5 pb-1.5 pt-0.5">
              ...
              <div className="min-w-0 flex-1 pt-0.5">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="inline-flex items-center gap-0.5 rounded-full bg-emerald-50 px-1.5 py-0.5 ty-body font-medium text-emerald-700">
              ...
              <div className="flex shrink-0 items-center gap-1.5">
                <button
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-[12px] border border-border/70 bg-[#f7f7f5] ty-body font-bold text-slate-600 transition hover:bg-card"
                >
            ...
            <div className="mt-1 flex items-center justify-between rounded-[12px] border border-border/70 bg-[#fafaf8] px-2.5 py-1.5">
              <div>
                <p className="ty-subtitle font-semibold text-slate-900">
              ...
              <button
                ...
                className="rounded-[10px] bg-emerald-50 px-2.5 py-1.5 ty-body font-semibold text-emerald-700 transition hover:bg-emerald-100"
              >
      ...
      <main className="mx-auto max-w-2xl space-y-3 px-3 py-3">
        <section className="grid grid-cols-3 gap-2">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="ty-body font-bold tracking-tight text-slate-900">
                {stat.value}
              </p>
              <p className="mt-0.5 ty-body text-slate-500">{stat.label}</p>
            </div>
          ))}
        </section>
        ...
        <section className="grid grid-cols-2 gap-2">
          {quickActions.map((item, index) => (
            ...
            >
              ...
              <div className="mt-2">
                <p className="ty-body font-semibold text-slate-900 transition group-hover:text-emerald-600">
                  {item.title}
                </p>
                <p className="mt-0.5 ty-body leading-[1.4] text-slate-500">
                  {item.description}
                </p>
              </div>
            </button>
          ...
          <section className="rounded-[18px] border border-border/70 bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
            <div className="mb-2 flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center gap-0.5 ty-body font-medium text-emerald-600"
              >
                {t('viewAll')}
                ...
                >
                  <div className="flex items-center justify-between gap-2.5">
                    <div className="min-w-0">
                      ...
                      <div className="mt-0.5 flex items-center gap-1 ty-body text-slate-500">
                    ...
                    <span className="shrink-0 ty-body font-bold text-emerald-600">
        ...
        <section>
          <h3 className="mb-2 px-0.5 ty-subtitle font-semibold uppercase tracking-[0.1em] text-slate-400">
            ...
            {menuItems.map((item, index) => (
              ...
              >
                <div className="flex min-w-0 items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="truncate ty-body font-medium text-slate-900 transition group-hover:text-emerald-600">
                      {item.label}
                    </p>
                    <p className="mt-0.5 ty-body text-slate-500">
                      {item.description}
        ...
        <section className="pb-2">
          <Button
            variant="outline"
            className="h-9 w-full rounded-[12px] border-border/70 bg-card ty-subtitle font-medium shadow-none hover:bg-slate-50"
            onClick={() => {
              setUserRole('client');
              navigate('home');
            }}
