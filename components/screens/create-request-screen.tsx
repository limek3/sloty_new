    ...
    return (
      <div className="min-h-screen bg-surface-2 px-4 safe-top safe-bottom">
        <div className="flex min-h-screen flex-col items-center justify-center">
          ...
          <h1 className="animate-slide-up text-center text-[14px] font-bold text-foreground">
            {isRu ? 'Заявка опубликована!' : 'Request Published!'}
          </h1>

          <p
            className="animate-slide-up mt-1.5 max-w-sm text-center text-[14px] leading-[1.4] text-muted-foreground"
          ...
          <Button
            className="animate-slide-up mt-5 h-10 w-full max-w-sm rounded-[12px] bg-emerald-500 text-[15px] font-semibold text-white shadow-primary-glow hover:bg-emerald-600"
  ...
  return (
    <div className="app-shell safe-bottom">
      ...
      <main className="mx-auto max-w-2xl space-y-2.5 px-3 py-3">
        <div className="rounded-[18px] border border-border/70 bg-card p-2.5 shadow-elevation-card">
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <Input
                ...
                className="h-9 rounded-[12px] border-border/70 bg-surface-1 text-[15px] shadow-none"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                className="min-h-20 resize-none rounded-[12px] border-border/70 bg-surface-1 text-[15px] shadow-none"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Select value={category} onValueChange={setCategory}>
                <SelectTrigger className="h-9 rounded-[12px] border-border/70 bg-surface-1 text-[15px] shadow-none">
                  <SelectValue
            ...
            <div className="space-y-1">
              <Label htmlFor="budget" className="text-[14px] font-medium text-foreground">
                {t('budget')} (₽) *
              </Label>
              <Input
                id="budget"
            ...
            <div className="space-y-1">
              <Label htmlFor="location" className="text-[14px] font-medium text-foreground">
                {t('location')} *
              </Label>
              <Input
                id="location"
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <div className="space-y-1">
                <Label htmlFor="date" className="text-[14px] font-medium text-foreground">
                  {t('preferredDate')}
                </Label>
                <Input
                  id="date"
              ...
              <div className="space-y-1">
                <Label htmlFor="time" className="text-[14px] font-medium text-foreground">
                  {t('preferredTime')}
                </Label>
                <Input
                  id="time"
            ...
            <div className="rounded-[12px] bg-surface-2 px-2.5 py-2 text-[15px] leading-[1.4] text-muted-foreground">
              {isRu
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 px-3 pb-3 safe-bottom">
        <div className="rounded-[18px] border border-border/70 bg-card p-2 shadow-elevation-card">
          <Button
            className="h-10 w-full rounded-[12px] bg-emerald-500 text-[15px] font-semibold text-white shadow-primary-glow hover:bg-emerald-600"
            disabled={!isValid}
