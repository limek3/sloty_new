    ...
    return (
      <div className="min-h-screen bg-background px-4 safe-top safe-bottom">
        <div className="flex min-h-screen flex-col items-center justify-center">
          ...
          <h1 className="animate-slide-up text-center text-[12px] font-bold text-foreground">
            {isRu ? 'Заявка опубликована!' : 'Request Published!'}
          </h1>

          <p
            className="animate-slide-up mt-1.5 max-w-sm text-center text-[12px] leading-[1.4] text-muted-foreground"
  ...
  return (
    <div className="app-shell safe-bottom">
      ...
      <main className="mx-auto max-w-2xl space-y-2.5 px-3 py-3">
        <div className="rounded-[18px] border border-border bg-card p-2.5 shadow-[0_6px_20px_rgba(15,23,42,0.04)]">
          <div className="space-y-3">
            <div className="space-y-1">
              <Label htmlFor="title" className="text-[12px] font-medium text-text-secondary">
                {t('requestTitle')} *
              </Label>
              <Input
                id="title"
                ...
                className="h-9 rounded-[12px] border-border bg-surface-tertiary text-[13px] shadow-none"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                className="min-h-20 resize-none rounded-[12px] border-border bg-surface-tertiary text-[13px] shadow-none"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Select value={category} onValueChange={setCategory}>
                <SelectTrigger className="h-9 rounded-[12px] border-border bg-surface-tertiary text-[13px] shadow-none">
                  <SelectValue
            ...
            <div className="space-y-1">
              <Label htmlFor="budget" className="text-[12px] font-medium text-text-secondary">
                {t('budget')} (₽) *
              </Label>
              <Input
                id="budget"
            ...
            <div className="space-y-1">
              <Label htmlFor="location" className="text-[12px] font-medium text-text-secondary">
                {t('location')} *
              </Label>
              <Input
                id="location"
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <div className="space-y-1">
                <Label htmlFor="date" className="text-[12px] font-medium text-text-secondary">
                  {t('preferredDate')}
                </Label>
                <Input
                  id="date"
              ...
              <div className="space-y-1">
                <Label htmlFor="time" className="text-[12px] font-medium text-text-secondary">
                  {t('preferredTime')}
                </Label>
                <Input
                  id="time"
            ...
            <div className="rounded-[12px] bg-surface-secondary px-2.5 py-2 text-[13px] leading-[1.4] text-muted-foreground">
              {isRu
